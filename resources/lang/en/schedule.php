...
return [
    ...
    'fields' => [
        ...
        'without_overlapping_expires_at' => 'Without overlapping lock TTL in minutes',
    ...
    'messages' => [
        ...
        'help-without-overlapping-expires-at' => 'Used only when without overlapping is enabled. Keep it close to the longest expected runtime.',
        ...
        'run-dispatched' => 'Schedule run started. Open history to follow the output.',
        'run-dispatch-error' => 'Unable to start the schedule run.',
